...
const buttonClasses = {
  ...
  primary:
    'inline-flex items-center gap-1 px-2 py-1 border border-blue-600 dark:border-blue-500 bg-blue-600 hover:bg-blue-700 disabled:hover:bg-blue-600 disabled:opacity-30 disabled:cursor-not-allowed text-white rounded-md shadow select-none focus:outline-none focus:ring-2 transition'
} as const;

interface ButtonProps {
  id?: string | undefined;
  children?: React.ReactNode;
  color?: 'none' | 'danger' | 'primary' | undefined;
