...
import { RecognitionDialog } from '../../recognition/RecognitionDialog';
    ...
    <>
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-wrap items-center gap-1">
          <Button
            color="primary"
            title={t('recognition.button')}
            onClick={() => setShowRecognition(true)}
          >
            <MdCameraAlt />
            {t('recognition.button')}
          </Button>
          <Dropdown
            label={
              <div className="py-1">
      ...
      {showRecognition && (
        <RecognitionDialog onClose={() => setShowRecognition(false)} />
      )}
    </>
  );
};
